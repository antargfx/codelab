...
import { initEditor, editorCommands, relayout } from './ui/editor.js';
...
function setMobileView(view) {
  ...
  // The editor must be re-laid-out once its pane is actually visible.
  if (view === 'editor') { relayout(); requestAnimationFrame(relayout); setTimeout(relayout, 150); }
}
