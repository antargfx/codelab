...
const App = (() => {
  ...
  async function init() {
    ...
    // Pre-fill default folder if set in config.js
    if (DRIVEFACE_CONFIG.defaultFolderId && !D.folderInput.value) {
      D.folderInput.value = DRIVEFACE_CONFIG.defaultFolderId;
      S.folderId = DRIVEFACE_CONFIG.defaultFolderId;
    }
